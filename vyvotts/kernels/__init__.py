...
Provides FA3 when available, falls back to PyTorch SDPA otherwise.
Override with environment variable:
  NAR_VAE_USE_FA3=0  - force SDPA instead of Flash Attention 3

The former ``VYVO_USE_FA3`` spelling remains a compatibility fallback.
"""
...
def _load_fa3_kernel():
    ...
    use_fa3 = os.environ.get("NAR_VAE_USE_FA3", os.environ.get("VYVO_USE_FA3"))
    if _FA3_LOAD_ATTEMPTED or use_fa3 == "0":
        return _fa3_kernel
