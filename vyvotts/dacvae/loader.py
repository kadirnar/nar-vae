...
def get_dacvae_class(backend: str = DEFAULT_DACVAE_BACKEND) -> type[Any]:
    ...
    module_name = "dacvae" if resolved_backend == "fast" else "vyvotts.dacvae.model"
...
def load_dacvae(
    ...
    *,
    ...
    model.vyvotts_backend = resolved_backend  # Compatibility with the former package name.
    return model
