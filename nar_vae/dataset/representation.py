...
LEGACY_CL100K_TEXT_FRONTEND_NAME = "nar_vae.encode_tts_text/cl100k_base"
LEGACY_CL100K_TEXT_FRONTEND_VERSION = 1
LEGACY_TEXT_FRONTENDS = frozenset(
    {(LEGACY_CL100K_TEXT_FRONTEND_NAME, LEGACY_CL100K_TEXT_FRONTEND_VERSION)}
)
